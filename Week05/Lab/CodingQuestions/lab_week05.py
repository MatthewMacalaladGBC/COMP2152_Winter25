...
if not input_invalid:
  ...
  @        ..@#% @     @&*#@(         % 
   &   (  @    (   / /   *    @  .   /  
    ...
    # Lab 5 - Question 3: Collect Loot First time
    loot_options, belt = functions_lab05.collect_loot(loot_options, belt)
    print("    ------------------------------------------------------------------")
    print("    |", end="    ")
    input("Roll for second item (Press enter)")

    # Lab 5 - Question 3: Collect Loot Second time
    loot_options, belt = functions_lab05.collect_loot(loot_options, belt)
    ...
    while input_invalid and tries in range(5):
        ...
        if len(name) != 2:
            print("    |    Please enter your Hero's name with two parts (separated by a space).")
            tries += 1
        else:
